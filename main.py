...
async def Subscribe(lel, message):
   ...
   if update_channel:
      try:
         ...
         await app.send_message(chat_id=message.chat.id, text="**Bir şeyler yanlış gitti. İletişim [Support](https://t.me/mutsuz_panda).**", parse_mode="markdown", disable_web_page_preview=True)
         return 1
